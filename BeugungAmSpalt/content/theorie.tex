...
\end{equation}
wovon de Facto jedoch nur der letzte Term relevant für die Intensitätsmessung ist. Mithilfe der Einführung der Konstante $\eta=\pi b\sin(\phi)/\lambda$
...
\end{equation}
verkürzen. Die Intensität lässt sich bei einer solchen Verteilung durch die zeitlich gemittelte Intensität
\begin{equation}
