...
\end{center}
\subsubsection{Berechnung von $\omega_-$}
$\omega_-$ berechnet sich mit \autoref{eq:omegaminus} für ein $\SI{0,5}{m}$ Pendel zu:
\begin{center}
  $\omega_-=\SI{4.4368\pm0.0029}{\frac{1}{s}}$
\end{center}

und für ein $\SI{0,75}{m}$ Pendel:
\begin{center}
  $\omega_+=\SI{3.6261\pm0.0017}{\frac{1}{s}}$
\end{center}

\subsubsection{Berechnung von $\omega_S$}
$\omega_S$ berechnet sich mit \autoref{eq:omegas} für ein $\SI{0,5}{m}$ Pendel zu:
\begin{center}
  $\omega_S=\SI{-0.0073\pm0.0029}{\frac{1}{s}}$
\end{center}
und für ein $\SI{0,75}{m}$ Pendel:
\begin{center}
  $\omega_S=\SI{-0.0095\pm0.0017}{\frac{1}{s}}$
\end{center}
